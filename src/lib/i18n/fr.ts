...
export const fr = {
  ...
  // Exploration des pochettes en trois dimensions.
  'crate.title': 'Bac à vinyle',
  'crate.intro': 'Le plaisir de fouiller. Un disque après l’autre.',
  'crate.grouping': 'Ranger les bacs',
  'crate.grouping.genre': 'Par genre',
  'crate.grouping.year': 'Par année',
  'crate.grouping.continent': 'Par continent',
  ...
  'crate.keyboard': 'Au clavier : flèches pour parcourir, Entrée pour ouvrir le disque.',
  'crate.previous': 'Disque précédent',
  'crate.next': 'Disque suivant',
  'crate.open': 'Ouvrir {title}',
  'crate.details': 'Voir la fiche',
  'crate.opening': 'Le disque sort du bac…',
  'crate.position': '{index} / {total}',
  'crate.count': '{count} disque(s)',
  'crate.bins': '{count} bac(s)',
  'crate.browse': 'Parcourir le bac',
  'crate.current': 'Disque sélectionné',
  'crate.empty': 'Votre bac attend ses premiers disques.',
  'crate.emptyHint': 'Importez votre collection pour retrouver vos pochettes ici.',
  'crate.emptyShared': 'Cette collection ne contient pas encore de disque.',
  'crate.collection': 'Vue collection',
  'crate.unknownGenre': 'Genre non renseigné',
  'crate.unknownYear': 'Année non renseignée',
  'crate.continent.africa': 'Afrique',
  'crate.continent.asia': 'Asie',
  'crate.continent.europe': 'Europe',
  'crate.continent.northAmerica': 'Amérique du Nord',
  ...
  'collection.switcher.label': 'Collection affichée',
  'collection.switcher.own': 'Ma collection',
  'collection.switcher.friends': 'Collections de vos amis',
  'collection.switcher.manage': 'Gérer mes amis',
  'collection.switcher.discover': 'Découvrir les collections de mes amis',
  ...
  'home.highlights.valuable.hint':
    'Classés par prix minimum proposé sur Discogs, en euros. Ce prix dépend des annonces et de leur état ; il ne représente pas une vente conclue.',
  'home.highlights.price': 'À partir de {price}',
  'home.highlights.empty': 'Importez votre collection pour découvrir vos tops.',
  'home.highlights.noWanted': 'Aucune édition recherchée avec les données disponibles.',
  'home.highlights.noPrice': 'Aucun prix de vente disponible pour le moment.',
